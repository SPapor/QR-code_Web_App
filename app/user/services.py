...
import jwt
from auth.regist import get_password_hash, create_jwt_token, verify_password
from core.settings import settings
from test_user.conftest import user_repo
...
class UserService:
    ...
    async def register(self, username:str ,password:str) -> tuple[User,tuple[str,str]]:
        ...
        refresh_token = create_jwt_token({"user_id": str(user.id)},
